...
static CHAN_X_1: StaticCell<Channel<NoopRawMutex, XRxMsg, 128>> = StaticCell::new();
pub static CHAN_X_RX: Channel<CriticalSectionRawMutex, XRxMsg, 64> = Channel::new();
...
async fn x_rx(receiver: Receiver<'static, NoopRawMutex, XRxMsg, 128>) {
    loop {
